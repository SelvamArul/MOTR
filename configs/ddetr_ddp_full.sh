...
EXP_DIR=exps/ycbv_ddetr_full
python -m torch.distributed.launch --nproc_per_node=8 \
    --use_env ddetr_main.py \
    --meta_arch ddetr \
    --dataset_file ycbv\
    ...
    --resume '/home/user/periyasa/workspace/MOTR/exps/ycbv_ddetr_full_12-Mar-2022_11:01/checkpoint.pth'\
    --epoch 200 \
    --num_workers 12 \
    --with_box_refine \
    --lr_drop 100 \
