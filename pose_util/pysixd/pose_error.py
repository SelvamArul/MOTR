...
def reproj(K, R_est, t_est, R_gt, t_gt, pts):
    ...
    :param R_est, t_est: Estimated pose (3x3 rot. matrix and 3x1 trans. vector).
    :param R_gt, t_gt: GT pose (3x3 rot. matrix and 3x1 trans. vector).
    :param pts: 3D model points (nx3 ndarray).
    :return: Error of pose_est w.r.t. pose_gt.
    """
...
def adi(R_est, t_est, R_gt, t_gt, pts):
    ...
    nn_dists, _ = nn_index.query(pts_gt, k=1, p=2)
...
def re(R_est, R_gt):
    ...
    :param R_est: Rotational element of the estimated pose (3x3 matrix).
    :param R_gt: Rotational element of the ground truth pose (3x3 matrix).
